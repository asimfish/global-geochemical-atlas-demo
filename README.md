...
- `research/`：科学发现层产物——五篇论文 PDF 全部成稿（P1 10 页 / P2 7 页 / P3 7 页 / P4 6 页 / P5 7 页，合计 37 页，均过 a–g 质量审计）、五篇论文路线图、同类数据库对比（含数字出处）。
...
12. 科学发现层：discovery_mode 自动选题长出五篇论文（五篇全部成稿、合计 37 页、a–g 审计全过，全部实测数字）；
